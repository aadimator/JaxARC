...
Complete API documentation for all JaxARC modules, auto-generated from source code docstrings.

JaxARC provides a JAX-native environment for training agents on ARC (Abstraction and Reasoning Corpus) tasks. The API is organized into several key modules:
