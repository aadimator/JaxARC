...
def demo_image_optimization():
    ...
    success = integration.initialize_run(experiment_config, run_name="image-optimization-test")
...
def demo_experiment_tagging():
    ...
    config = WandbConfig(
        enabled=True,
        project_name="jaxarc-tagging-demo",
        offline_mode=True
    )
...
def demo_config_factories():
    ...
    research_config = create_research_wandb_config(
        project_name="jaxarc-research-project",
    ...
    dev_config = create_development_wandb_config(
        project_name="jaxarc-dev-project"
    )
    print("\nDevelopment Config:")
