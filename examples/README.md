...
This directory contains comprehensive examples demonstrating JaxARC features,
...
**Do not use deprecated examples.** They are kept for reference only and will be
