...
def demonstrate_concept_specific_usage(concept: str):
    ...
    try:
        ...
        for i, task_id in enumerate(concept_tasks[:5]):
            ...
            console.print(f"  {i+1}. {task_id} ({metadata['num_demonstrations']} demos, {metadata['num_test_inputs']} tests)")
...
def main(
    concept: str = typer.Option(None, "--concept", "-c", help="Specific concept group to demonstrate"),
    ...
    try:
        ...
        console.print("  • python examples/concept_arc_demo.py --concept Copy --verbose")
