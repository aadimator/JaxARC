...
This directory contains sophisticated examples that demonstrate advanced JaxARC features, performance optimization, and complex workflows.
...
- **`memory_optimization_demo.py`** - Memory management and optimization techniques
  - Lazy loading patterns for large datasets
  - Compressed storage for visualization data
  - Garbage collection optimization
  - Memory usage monitoring and cleanup
  - **Run with**: `pixi run python examples/advanced/memory_optimization_demo.py`
...
### JAX Integration
- **Debug Callbacks**: Using `jax.debug.callback` for visualization during transformations
