...
class ConfigComposer:
    ...
    def compose_config(
        ...
        try:
            config = compose(config_name=config_name, overrides=overrides, return_hydra_config=return_hydra_config)
            return config
    ...
    def create_override_suggestions(self, field_path: str, current_value: Any) -> List[str]:
...
def create_config_composer(config_dir: Optional[Union[str, Path]] = None) -> ConfigComposer:
