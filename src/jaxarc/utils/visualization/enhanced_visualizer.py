...
class VisualizationConfig:
    ...
    def should_visualize_step(self, step_num: int) -> bool:
        ...
        if self.debug_level == "off":
            return False
        elif self.debug_level == "minimal":
            return False  # Only episode summaries
        elif self.debug_level == "standard":
    ...
    def get_color_palette(self) -> Dict[int, str]:
        ...
        elif self.color_scheme == "high_contrast":
...
class EnhancedVisualizer:
    ...
    def __init__(
        ...
        if config.wandb_config.enabled:
            self.wandb_integration = wandb_integration or WandbIntegration(config.wandb_config)
        ...
        logger.info(f"Enhanced visualizer initialized with debug level: {config.debug_level}")
    ...
    def _create_step_svg(self, step_data: StepVisualizationData) -> Optional[Path]:
        ...
        try:
            from .core import draw_rl_step_svg_enhanced, detect_changed_cells, get_operation_display_name, infer_fill_color_from_grids
    ...
    def _create_episode_summary(self, summary_data: EpisodeSummaryData) -> Optional[Path]:
        """Create episode summary visualization."""
        try:
