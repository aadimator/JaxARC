...
class TestSerializeState:
    ...
    def test_serialize_state_values(self, sample_state):
        ...
        np.testing.assert_array_equal(result["selected"], [[False, True], [False, False]])
...
class TestSerializeLogStep:
    ...
    def test_serialize_log_step_complex(self, sample_state):
        ...
        step_data = {
            ...
            "info": {
                "metrics": {
                    "similarity": jnp.float32(0.9),
                    "steps": jnp.int32(15)
                },
                "debug": {
                    "grid_changes": jnp.array([1, 2, 3]),
                    "message": "test"
                }
            },
            "custom_arrays": [
