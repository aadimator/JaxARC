...
class TestExtractValidRegion:
    ...
    def test_extract_valid_region_no_mask(self):
        ...
        valid_grid, (start_row, start_col), (height, width) = _extract_valid_region(grid)
    ...
    def test_extract_valid_region_with_mask(self):
        ...
        mask = np.array([[True, True, True, False], [True, True, True, False], [False, False, False, False]])
    ...
    def test_extract_valid_region_partial_mask(self):
        ...
        mask = np.array([[False, True, True], [False, True, True], [False, False, False]])
...
class TestInfoMetricExtraction:
    ...
    def test_get_info_metric_with_jax_arrays(self):
        ...
        info = {
            "metrics": {
                "similarity": jnp.array(0.9),
                "step_count": jnp.array(20)
            }
        }
...
class TestDrawGridSVG:
    ...
    def test_draw_grid_svg_with_label(self):
        ...
        text_elements = [elem for elem in drawing.elements if isinstance(elem, drawsvg.Text)]
...
class TestDrawingUtilities:
    ...
    def test_add_change_highlighting(self):
        ...
        add_change_highlighting(
            drawing, changed_cells, 0, 0, 1.0, 0, 0, 2, 2
        )
