...
class TestValidateDataset:
    ...
    def test_validate_dataset_exists_and_valid(self, temp_output_dir, sample_dataset_config):
    ...
    def test_validate_dataset_empty_directory(self, temp_output_dir, sample_dataset_config):
    ...
    def test_validate_dataset_missing_subdirs(self, temp_output_dir, sample_dataset_config):
    ...
    def test_validate_dataset_is_file_not_directory(self, temp_output_dir, sample_dataset_config):
    ...
    def test_validate_dataset_permission_error(self, temp_output_dir, sample_dataset_config):
...
class TestDownloadDataset:
    ...
    def test_download_dataset_success(self, temp_output_dir, sample_dataset_config):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            with patch.object(manager, 'validate_dataset', return_value=True):
                result_path = manager.download_dataset(sample_dataset_config, target_path)
    ...
    def test_download_dataset_git_not_found(self, temp_output_dir, sample_dataset_config):
    ...
    def test_download_dataset_validation_fails(self, temp_output_dir, sample_dataset_config):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            with patch.object(manager, 'validate_dataset', return_value=False):
                with pytest.raises(DatasetError, match="Downloaded dataset failed validation"):
                    manager.download_dataset(sample_dataset_config)

    def test_download_dataset_uses_config_path(self, temp_output_dir, sample_dataset_config):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            with patch.object(manager, 'validate_dataset', return_value=True):
                with patch('jaxarc.utils.dataset_manager.here') as mock_here:
                    ...
                    result_path = manager.download_dataset(sample_dataset_config, target_path=None)
...
class TestEnsureDatasetAvailable:
    ...
    def test_ensure_dataset_available_exists_valid(self, temp_output_dir, sample_jaxarc_config):
    ...
    def test_ensure_dataset_available_missing_no_auto_download(self, temp_output_dir, sample_jaxarc_config):
        ...
        with patch('jaxarc.utils.dataset_manager.here') as mock_here:
            ...
            with pytest.raises(DatasetError, match="not found.*Set auto_download=True"):
                manager.ensure_dataset_available(sample_jaxarc_config, auto_download=False)

    def test_ensure_dataset_available_missing_with_auto_download(self, temp_output_dir, sample_jaxarc_config):
        ...
        with patch('jaxarc.utils.dataset_manager.here') as mock_here:
            ...
            with patch.object(manager, 'download_dataset') as mock_download:
                ...
                result_path = manager.ensure_dataset_available(sample_jaxarc_config, auto_download=True)
                
                assert result_path == expected_path
                mock_download.assert_called_once()

    def test_ensure_dataset_available_dataset_config_directly(self, temp_output_dir, sample_dataset_config):
    ...
    def test_ensure_dataset_available_absolute_path(self, temp_output_dir, sample_dataset_config):
...
class TestGetDatasetRecommendations:
    ...
    def test_get_recommendations_unknown_dataset(self):
        ...
        with patch('jaxarc.utils.dataset_manager.logger') as mock_logger:
            recommendations = DatasetManager.get_dataset_recommendations("UnknownDataset")
    ...
    def test_complete_dataset_setup_workflow(self, temp_output_dir):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            with patch('jaxarc.utils.dataset_manager.here') as mock_here:
                ...
                result_path = manager.ensure_dataset_available(config, auto_download=True)
...
class TestEdgeCasesAndBoundaryConditions:
    ...
    def test_dataset_validation_with_symlinks(self, temp_output_dir, sample_dataset_config):
    ...
    def test_concurrent_dataset_operations(self, temp_output_dir):
        ...
        def validate_worker():
            try:
                ...
                # Create dataset
                dataset_path = temp_output_dir / f"Dataset_{threading.current_thread().ident}"
