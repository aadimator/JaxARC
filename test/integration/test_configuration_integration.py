...
class TestConfigurationDrivenEnvironmentCreation:
    ...
    def test_environment_creation_from_config(self):
        ...
        try:
            ...
            assert env_params.max_episode_steps == jax_config.environment.max_episode_steps
    ...
    def test_different_dataset_configs(self):
        ...
        for config_name, dataset_key in datasets:
            try:
                ...
                # Verify dataset-specific configuration
                assert env_params.dataset.dataset_name == jax_config.dataset.dataset_name
                assert env_params.dataset.max_grid_height == jax_config.dataset.max_grid_height
                assert env_params.dataset.max_grid_width == jax_config.dataset.max_grid_width
    ...
    def test_action_config_environment_integration(self):
        ...
        for action_config in action_configs:
            try:
                ...
                # Verify action configuration
                assert env_params.action.max_operations == jax_config.action.max_operations
                assert env_params.action.validate_actions == jax_config.action.validate_actions
    ...
    def test_reward_config_environment_integration(self):
        ...
        for reward_config in reward_configs:
            try:
                ...
                assert env_params.reward.similarity_weight == jax_config.reward.similarity_weight
