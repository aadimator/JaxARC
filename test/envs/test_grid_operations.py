...
from jaxarc.types import GridArray, SelectionArray, OperationId
...
class TestHelperFunctions:
    ...
    def test_apply_within_bounds(self):
        ...
        selection = jnp.array([[True, False, True], [False, True, False], [True, False, True]], dtype=jnp.bool_)
    ...
    def test_get_effective_selection(self):
        ...
        selection = jnp.array([[True, False, False], [False, False, False], [False, False, False]], dtype=jnp.bool_)
    ...
    def test_validate_bounding_box_for_operation(self):
        ...
        assert validate_bounding_box_for_operation(0, 2, 0, 2, require_square=True) == True  # 3x3 square
        assert validate_bounding_box_for_operation(0, 2, 0, 1, require_square=True) == False  # 3x2 rectangle
...
class TestClipboardOperations:
    ...
    def test_cut_to_clipboard(self, test_state: State):
        ...
        chex.assert_trees_all_equal(
            result_state.working_grid[2:, :], 
            test_state.working_grid[2:, :]
        )
