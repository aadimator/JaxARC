...
class TestJaxArcConfigHydraIntegration:
    ...
    def test_from_hydra_partial_config(self):
        ...
        hydra_config = DictConfig({
            ...
            "action": {"num_operations": 40}  # ActionConfig uses num_operations in Hydra
        })
    ...
    def test_from_hydra_complete_config(self):
        ...
        hydra_config = DictConfig({
            ...
            "action": {"num_operations": 50, "validate_actions": False},  # Use num_operations
...
class TestJaxArcConfigComposition:
    ...
    def test_component_independence(self):
        ...
        assert config1.environment.max_episode_steps != config2.environment.max_episode_steps
