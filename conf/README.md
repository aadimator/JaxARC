...
This directory contains Hydra configuration files for JaxARC. The configuration is organized into logical groups that correspond to the Python configuration classes.
...
### Storage (`storage/`)
- `development.yaml` - Development-friendly storage (small limits, quick cleanup)
...
The main `JaxArcConfig` class combines all these configurations into a unified, typed configuration object that supports YAML serialization and validation.