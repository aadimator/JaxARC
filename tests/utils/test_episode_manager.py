...
class TestEpisodeConfig:
    ...
    def test_validation_invalid_base_dir(self) -> None:
        ...
        with pytest.raises(ValueError, match="base_output_dir must be a non-empty string"):
...
class TestEpisodeManager:
    ...
    def test_initialization_invalid_base_dir(self) -> None:
        ...
        with pytest.raises(ValueError, match="Cannot access or write to base directory"):
