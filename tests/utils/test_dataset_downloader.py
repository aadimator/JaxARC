...
class TestDatasetDownloader:
    ...
    def test_validate_conceptarc_structure_missing_corpus(self, tmp_path):
        ...
        with pytest.raises(
            DatasetDownloadError, match="ConceptARC corpus directory not found"
        ):
    ...
    def test_validate_miniarc_structure_missing_data(self, tmp_path):
        ...
        with pytest.raises(
            DatasetDownloadError, match="MiniARC data directory not found"
        ):
    ...
    def test_custom_target_directory(self, tmp_path):
        ...
        mock_clone.assert_called_once_with(
            "https://github.com/victorvikram/ConceptARC.git", custom_dir, "ConceptARC"
        )
