...
class TestGridVisualization:
    ...
    def test_visualize_grid_rich_basic(self):
        ...
        table = visualize_grid_rich(test_grid, title="Test Grid")
        
        assert isinstance(table, Table)
        assert "Test Grid (2x3)" in str(table)
    ...
    def test_visualize_grid_rich_with_mask(self):
        ...
        table = visualize_grid_rich(test_grid, mask, title="Masked Grid")
        
        assert isinstance(table, Table)
        assert "Masked Grid" in str(table)
    ...
    def test_visualize_grid_rich_empty(self):
        ...
        table = visualize_grid_rich(empty_grid, title="Empty Grid")
    ...
    def test_grid_with_mask_partial_valid(self):
        ...
        table = visualize_grid_rich(test_grid, mask, title="Partial Grid")
        assert isinstance(table, Table)
