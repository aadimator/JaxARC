...
def test_concept_arc_parser_initialization(concept_arc_config, mock_concept_arc_directory):
...
def test_concept_arc_parser_concept_based_sampling(concept_arc_config, mock_concept_arc_directory):
...
def test_concept_arc_parser_invalid_concept(concept_arc_config, mock_concept_arc_directory):
    ...
    with patch("jaxarc.parsers.concept_arc.here") as mock_here:
        ...
        with pytest.raises(ValueError, match="Concept group 'InvalidConcept' not found"):
...
def test_concept_arc_parser_task_preprocessing(concept_arc_config, sample_concept_arc_task):
    ...
    with patch("jaxarc.parsers.concept_arc.here") as mock_here:
        ...
        # Check array shapes
        assert jax_task.input_grids_examples.shape == (4, 30, 30)  # max_train_pairs, max_h, max_w
        assert jax_task.test_input_grids.shape == (3, 30, 30)  # max_test_pairs, max_h, max_w
...
def test_concept_arc_parser_get_random_task(concept_arc_config, mock_concept_arc_directory):
...
def test_concept_arc_parser_get_task_by_id(concept_arc_config, mock_concept_arc_directory):
...
def test_concept_arc_parser_metadata_and_statistics(concept_arc_config, mock_concept_arc_directory):
