...
class TestEnhancedVisualizer:
    ...
    def test_start_episode(
        self, enhanced_visualizer: EnhancedVisualizer, temp_dir: Path
    ) -> None:
    ...
    def test_visualize_step_standard_level(
        self, enhanced_visualizer: EnhancedVisualizer, temp_dir: Path
    ) -> None:
        ...
        assert (
            enhanced_visualizer.async_logger.queue.qsize() >= 0
        )  # May have been processed

    def test_visualize_step_off_level(
    ...
    def test_visualize_step_verbose_level(
        self, enhanced_visualizer: EnhancedVisualizer, temp_dir: Path
    ) -> None:
    ...
    def test_visualize_episode_summary(
        self, enhanced_visualizer: EnhancedVisualizer, temp_dir: Path
    ) -> None:
    ...
    def test_create_comparison_visualization(
        ...
        with patch(
            ...
            result = enhanced_visualizer.create_comparison_visualization(
                episodes_data, comparison_type="reward_progression"
            )
    ...
    def test_performance_monitoring(
        ...
        with patch(
            "jaxarc.utils.visualization.enhanced_visualizer.draw_rl_step_svg",
            side_effect=slow_visualization,
        ):
    ...
    def test_error_handling_visualization_failure(
        self, enhanced_visualizer: EnhancedVisualizer, temp_dir: Path
    ) -> None:
        ...
        with patch(
            "jaxarc.utils.visualization.enhanced_visualizer.draw_rl_step_svg",
            side_effect=Exception("Visualization error"),
        ):
    ...
    def test_jax_compatibility(
        ...
        assert (
            not isinstance(call_args[0][0], jnp.ndarray) or True
        )  # Allow both numpy and jax arrays
