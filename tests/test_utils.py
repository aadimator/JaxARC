...
class EquinoxTestUtils:
    ...
    def assert_equinox_module(module: Any) -> None:
        ...
        assert eqx.is_array_like(module), f"Object {type(module)} is not an Equinox module"
    ...
    @staticmethod
    def assert_module_validation(module_class: type, valid_args: dict, invalid_args: dict) -> None:
        """
    ...
    def assert_module_immutable(module: Any) -> None:
        ...
        if hasattr(module, '__dataclass_fields__'):
            ...
            if hasattr(module, 'replace'):
                ...
                assert not eqx.tree_equal(module, new_module) or eqx.tree_equal(module, new_module)
...
class MockDataGenerator:
    ...
    @staticmethod
    def create_mock_grid(height: int = 5, width: int = 5, key: jax.Array | None = None) -> tuple[jnp.ndarray, jnp.ndarray]:
        """
    ...
    @staticmethod
    def create_mock_action(height: int = 10, width: int = 10, key: jax.Array | None = None) -> dict[str, Any]:
        """
...
def create_test_grid(height: int = 5, width: int = 5) -> tuple[jnp.ndarray, jnp.ndarray]:
