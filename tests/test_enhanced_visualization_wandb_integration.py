...
class TestWandbConfig:
    ...
    def test_config_validation_image_size(self) -> None:
        ...
        with pytest.raises(ValueError, match="max_image_size must have positive dimensions"):
...
class TestWandbIntegration:
    ...
    @pytest.fixture
    def wandb_integration(self, wandb_config: WandbConfig, mock_wandb) -> WandbIntegration:
        """Create wandb integration for testing."""
        return WandbIntegration(wandb_config)
    
    def test_initialization_enabled(self, wandb_integration: WandbIntegration, wandb_config: WandbConfig) -> None:
    ...
    def test_initialize_run_success(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
    ...
    def test_initialize_run_failure(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
        ...
        with pytest.raises(Exception):  # Generic exception since WandbError may not exist
            wandb_integration.initialize_run({"test": "config"})
        
        assert wandb_integration.is_initialized is False
    
    def test_log_step_success(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
    ...
    def test_log_step_not_initialized(self, wandb_integration: WandbIntegration) -> None:
    ...
    def test_log_step_frequency_filtering(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
    ...
    def test_log_episode_summary(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
    ...
    def test_log_episode_summary_not_initialized(self, wandb_integration: WandbIntegration) -> None:
    ...
    def test_image_optimization(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
        ...
        wandb_integration.log_step(
            step_num=1,
            metrics={"reward": 0.5},
            images={"large_image": large_image}
        )
    ...
    def test_network_error_handling(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
    ...
    def test_network_error_max_retries(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
    ...
    def test_sync_offline_data(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
    ...
    def test_finish_run_not_initialized(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
    ...
    def test_context_manager(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
    ...
    def test_context_manager_exception(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
    ...
    def test_get_run_url(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
        ...
        # Mock run with URL
        mock_run = MagicMock()
        mock_run.get_url.return_value = "https://wandb.ai/test-entity/test-project/runs/test-run"
        mock_wandb.init.return_value = mock_run
    ...
    def test_get_run_url_not_initialized(self, wandb_integration: WandbIntegration) -> None:
        """Test getting run URL when not initialized."""
        url = wandb_integration.get_run_url()
        assert url is None
    
    def test_log_config_changes(self, wandb_integration: WandbIntegration, mock_wandb) -> None:
