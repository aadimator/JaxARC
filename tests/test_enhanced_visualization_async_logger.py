...
class TestAsyncLogger:
    ...
    @pytest.fixture
    def async_logger(
        self, logger_config: AsyncLoggerConfig, temp_dir: Path
    ) -> AsyncLogger:
    ...
    def test_initialization(
        self, async_logger: AsyncLogger, logger_config: AsyncLoggerConfig
    ) -> None:
    ...
    def test_log_step_visualization(
        self, async_logger: AsyncLogger, temp_dir: Path
    ) -> None:
    ...
    def test_concurrent_logging(
        ...
        def log_entries(thread_id: int) -> None:
            try:
                for i in range(10):
                    entry = LogEntry(data={"thread_id": thread_id, "entry_id": i})
                    async_logger.log_entry(entry)
