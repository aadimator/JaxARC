        ...
        if hasattr(instance, "__dataclass_fields__"):
            ...
            if field_names:
                ...
                modified_instance = eqx.tree_at(
                    lambda x: getattr(x, field_name), instance, original_value
                )
...
def run_equinox_module_tests(
    module_class: type[T], valid_init_args: dict[str, Any]
) -> None:
